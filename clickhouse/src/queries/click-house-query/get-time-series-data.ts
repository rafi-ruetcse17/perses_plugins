...
import { ClickHouseQuerySpec, DatasourceQueryResponse } from './click-house-query-types';
...
export const getTimeSeriesData: TimeSeriesQueryPlugin<ClickHouseQuerySpec>['getTimeSeriesData'] = async (
  spec,
  context
) => {
